...
public class specificchat extends AppCompatActivity {
    ...
    ImageView mimageviewofspecificuser,checkmark;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkmark=findViewById(R.id.checkmarkviewofspecificuser);
        ...
        if (mrecieveruid.equals("0SmgO1JrZWRtpd7FmGGIQE9RAlK2")){
